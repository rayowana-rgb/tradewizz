...
Map<String, dynamic> _portfolioJson({bool withPositions = true}) => {
      'summary': {
      ...
      'positions': withPositions
          ...
          : <Map<String, dynamic>>[],
      'brokers': withPositions ? ['MOOMOO'] : <String>[],
      'errors': <Map<String, dynamic>>[],
    };

StockRepository _repo({bool withPositions = true}) => StockRepository(
      client: ApiClient(
        config: const AppConfig(baseUrl: 'https://test.tradewiz.app/v1'),
        httpClient: MockClient((req) async {
          if (req.url.path.endsWith('/portfolio')) {
            return http.Response(
              jsonEncode(_portfolioJson(withPositions: withPositions)),
              200,
