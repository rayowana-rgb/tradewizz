    ...
    def _screen_one(
        ...
        try:
            ...
            return ScreenerMatch(
                ...
                conviction_reasons=overlay.get("conviction_reasons", []),
                confirmations_fired=overlay.get("confirmations_fired", 0),
                confirmations_total=overlay.get("confirmations_total", 0),
                trade_ready=overlay.get("trade_ready", False),
